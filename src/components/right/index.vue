...
export default {
  ...
  data () {
    return {
      ...
      artCommentList: [
        {
          ...
          nickname: '路人甲',
          title: '别再用CMD了，配置一个比mac终端还美的Windows Terminal',
          content: '这是一条来自路人甲的评论'
        },
        {
          id: '2',
          avatar: '../../assets/img/tou.jpg',
        ...
        },
        {
          ...
          nickname: '路人丙',
          title: '《猫态各异》',
          content: '拍的好好！up在哪学的摄影'
        },
        {
          id: '4',
          avatar: '../../assets/img/tou.jpg',
          nickname: '路人丁',
          title: '将“戒游戏”设为锁屏密码有助于养成习惯',
          content: '学到了'
        }
      ],//评论量最多
      ...
      catchMeObj: {//抓住我 个人信息{
        git: 'https://github.com/YuDGang',
        qq: 'static/img/lil/QQ.jpg',
        sina: 'https://weibo.com/u/2917228965',
        wechat: 'static/img/lil/erwm.jpg',
        csdn: 'http://blog.csdn.net/TheYoungBoyLHG',
        // job: 'http://namenamename.mangoya.cn'
