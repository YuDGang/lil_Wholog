<template>
  <div class="footBack footBackQian">
    ...
    <div class="fcontainer">
      ...
      <p>
        托管于
        <a href="https://github.com/YuDGang/Lil_Who_Log" target="_blank">GitHub</a>.
        <a href="https://www.aliyun.com/" target="_blank">阿里云</a> 提供静态文件云存储服务.
...
export default {
  ...
  methods: {
    runTime () {
      //运行倒计时
      var oldTime = new Date('2020/10/20 00:00:00')
      setInterval(() => {
